...
// Editor de Corte (Mover y Redimensionar)
...
const handleSave = async () => {
  ...
  if (success) {
    ...
    showCustomAlert('¡Excelente!', 'Tus cambios han sido guardados exitosamente.', 'success');
  } else {
    showCustomAlert('Error al guardar', 'No se pudieron guardar los cambios. Intenta de nuevo.', 'error');
  }
};
      ...
      >
        ...
        >
          ...
          <div class="w-full flex items-center justify-between py-4 text-white max-w-[340px] shrink-0">
            ...
            <button @click="showCropModal = false" class="text-white hover:text-gray-300 transition-colors p-1.5 focus:outline-none">
          ...
          <div class="relative w-[300px] h-[300px] bg-neutral-955 overflow-hidden rounded-lg flex items-center justify-center select-none touch-none border border-white/10 shadow-lg">
            <!-- Imagen cargada -->
            <img 
              :src="rawImageSrc" 
              ref="imgRef"
