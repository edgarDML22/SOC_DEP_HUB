            ...
            <div class="px-5 py-4 flex-1 flex flex-col justify-between space-y-4">
                ...
                <div class="flex items-center gap-3 text-slate-700 min-w-0">
                  ...
                  <div class="flex flex-col min-w-0">
                    ...
                    <div class="flex items-center gap-1.5 flex-wrap">
                      ...
                      <span
                        class="px-1.5 py-0.5 rounded text-[8px] font-black uppercase tracking-wider border leading-none"
                        :class="sesion.es_cupo_lleno 
                          ? 'bg-rose-50 border-rose-200 text-rose-700'
                          : 'bg-violet-50 border-violet-200 text-violet-850'"
                      >
                        {{ sesion.es_cupo_lleno ? 'Lleno' : `${sesion.disponible} libres` }}
                      </span>
                    </div>
                  </div>
                </div>
              ...
              <div class="pt-3 border-t border-slate-100">
                ...
                <div
                  ...
                  class="w-full flex items-center justify-center gap-2 bg-emerald-50 border border-emerald-255 text-emerald-700 rounded-xl px-4 py-2.5 text-xs font-bold shadow-inner"
                >
                ...
                <button
                  ...
                  class="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-emerald-600 to-teal-650 hover:from-emerald-500 hover:to-teal-555 text-white rounded-xl px-4 py-2.5 text-xs font-bold border border-emerald-700 shadow-md hover:shadow-lg hover:shadow-emerald-500/10 active:scale-[0.98] transition-all duration-300 disabled:opacity-60 disabled:cursor-not-allowed cursor-pointer focus:outline-none"
                >
