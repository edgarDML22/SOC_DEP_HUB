  ...
  <div class="w-full px-4 md:px-6 lg:px-8 pb-24 md:pb-8">
    <div class="max-w-7xl mx-auto space-y-6">
      ...
      <div v-else class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        >
          <!-- Header de la card — badge ABIERTA en verde -->
          <div class="bg-gradient-to-r from-emerald-500 to-teal-600 px-5 py-3.5 flex items-center justify-between">
          ...
          <div class="px-5 py-4 flex-1 space-y-3">
            ...
            <div class="flex items-center gap-2">
              ...
              <span class="text-xs font-semibold text-surface-500">
                {{ sesion.cantidad_inscritos }} inscritos · Sin límite de cupo
              </span>
            </div>
          </div>
          ...
          <div class="px-5 pb-5">
            ...
            <button
              ...
              :disabled="inscribiendoId === sesion.id_sesion || store.loadingAccion"
            ...
            >
              ...
              {{ inscribiendoId === sesion.id_sesion ? 'Inscribiendo...' : 'Inscribirse' }}
            </button>
          </div>
        </div>
      </div>
