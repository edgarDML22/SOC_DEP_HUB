  ...
  <div class="w-full px-4 md:px-6 lg:px-8 pb-24 md:pb-8">
    <div class="max-w-7xl mx-auto space-y-6">
      ...
      <div v-if="store.loading" class="flex flex-col items-center py-20">
        ...
        <p class="text-slate-500 font-semibold text-sm">Cargando actividades abiertas...</p>
      </div>
      ...
      >
        ...
        <p class="text-slate-900 font-extrabold text-xl">Sin actividades abiertas</p>
        ...
        <button
          v-if="store.hayFiltrosActivos"
          @click="store.resetFiltros()"
          class="mt-5 px-5 py-2.5 rounded-xl text-sm font-extrabold text-white bg-blue-600 hover:bg-blue-500 transition-all cursor-pointer shadow-md shadow-blue-500/10"
        >
          Limpiar filtros
        </button>
      </div>
