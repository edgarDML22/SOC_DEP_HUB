    ...
    <div class="w-full px-4 md:px-6 lg:px-8 pb-24 md:pb-8">
      <div class="max-w-7xl mx-auto">
        ...
        <div v-if="activeView === 'hoy'"
          ...
          <p class="text-surface-900 font-bold text-lg">Agenda de Hoy</p>
          <p class="text-surface-500 font-medium text-sm text-center max-w-xs mt-1">
            Vista de todas tus reservaciones y actividades del día. Próximamente.
          </p>
        </div>
        ...
        <div v-else
          ...
          <p class="text-surface-500 font-medium text-sm text-center max-w-xs mt-1">
            Visualiza todas tus actividades de la semana en formato calendario. Próximamente.
          </p>
        </div>
