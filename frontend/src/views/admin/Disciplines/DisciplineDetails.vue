        ...
        <div class="max-w-4xl mx-auto space-y-6">
            ...
            <Transition enter-active-class="transition-all duration-500 ease-out"
                ...
                <div v-if="discipline && !isLoading" class="space-y-6">
                        ...
                        <div class="p-8 lg:p-10">
                            <div
                                ...
                                <div class="flex gap-6 items-center">
                                    ...
                                    <div>
                                        ...
                                        <p
                                            class="text-primary-600 font-bold uppercase tracking-widest text-xs flex items-center gap-2 mt-2">
                                ...
                                <div class="flex flex-col items-end gap-2 shrink-0">
                                    ...
                                    <button v-if="!isEditing" @click="openDeleteModal"
                                        class="px-5 py-2.5 bg-white text-red-600 rounded-xl font-bold hover:bg-red-50 transition-colors text-sm flex items-center gap-2 border border-surface-200 hover:border-red-200 shadow-sm w-full md:w-auto justify-center">
                                        <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <div v-if="!isEditing"
                                ...
                                <div class="space-y-6">
                                    <div
                                        ...
                                        <span
                                            class="text-[10px] font-extrabold uppercase tracking-widest text-surface-500">ID
                                            Disciplina</span>
                                        <span class="text-base font-bold text-surface-900">#{{ discipline.id_disciplina
                                            }}</span>
                                    </div>
                                    <div
                                        class="bg-surface-50/50 rounded-2xl p-4 border border-surface-100 flex flex-col gap-1.5">
                                ...
                                <div class="space-y-6 h-full">
                                    <div
                                        class="bg-surface-50/50 rounded-2xl p-5 border border-surface-100 h-full flex flex-col gap-2">
                                        <span
                                            class="text-[10px] font-extrabold uppercase tracking-widest text-surface-500">Descripción</span>
                                        <p class="text-sm font-medium text-surface-700 leading-relaxed">{{
                                            discipline.descripcion || 'Sin descripción disponible.' }}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div v-else
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div class="space-y-1.5">
                                        <label
                                            class="text-[10px] font-black uppercase tracking-widest text-surface-500 px-1">Estatus</label>
                                ...
                                <div class="space-y-1.5">
                                    <label
                                        class="text-[10px] font-black uppercase tracking-widest text-surface-500 px-1">Descripción</label>
                    ...
                    <!-- Instructors Section -->
                    <article
                        class="bg-white rounded-[2.5rem] shadow-xl shadow-surface-200/40 border border-surface-200 overflow-hidden">
                        <div class="p-8 lg:p-10">
                            ...
                            <div v-if="discipline.instructores?.length" class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div v-for="ins in discipline.instructores" :key="ins.id_instructor"
                                    ...
                                    <div
                                        class="w-12 h-12 bg-linear-to-br from-primary-500 to-primary-700 text-white rounded-[1.25rem] flex items-center justify-center font-black text-lg shadow-inner group-hover:scale-105 transition-transform shrink-0">
                                        {{ ins.nombre_completo.charAt(0) }}
                                    </div>
                                    <div class="min-w-0 flex-1">
                                        <p class="font-bold text-surface-900 truncate">{{ ins.nombre_completo }}</p>
                                        <p
                                            class="text-[11px] font-bold text-surface-400 uppercase tracking-widest mt-0.5">
                                            ID: #{{ ins.id_instructor }}</p>
                                    </div>
                    ...
                    <Transition enter-active-class="transition-all duration-300 ease-out"
                        ...
                        <div v-if="showDeleteModal"
                            ...
                            <div class="p-8">
                                ...
                                <p class="text-sm font-medium text-surface-500 mb-8 leading-relaxed">¿Estás seguro de
                                    deshabilitar <b class="text-surface-900">{{ discipline?.nombre_disciplina }}</b>? El
