                        ...
                        <div class="p-8 lg:p-10">
                            ...
                            <div class="mt-8 pt-6 border-t border-surface-100 flex justify-end">
                                <button @click="showEditModal = true"
                                    class="w-full sm:w-auto px-6 py-3.5 rounded-xl bg-primary-600 text-white font-bold hover:bg-primary-700 transition-all shadow-sm hover:shadow-md">
                    ...
                    <Transition enter-active-class="transition-all duration-300 ease-out"
                        ...
                        <div v-if="showEditModal"
                            ...
                            <div
                                ...
                                <button @click="showEditModal = false"
                                    class="px-6 py-3 rounded-xl border border-surface-200 bg-white text-sm font-bold text-surface-700 hover:bg-surface-50 transition-colors">Cancelar</button>
                                <button @click="saveEditInstructor" :disabled="isSaving"
