<template>
  <div class="wizard-step">
    <h2 class="step-title">{{ store.tipo === 'EQUIPO' ? 'Datos del Capitán' : 'Datos Personales' }}</h2>
    <p class="step-description">Ingresa la información del participante principal.</p>
        ...
        <div class="form-group full-width">
          ...
          <div class="ranking-input-wrapper">
            <input 
              ...
              required
            />
            <span class="input-info">Ingresa un valor entre 0 y 500 basado en tu nivel actual.</span>
          </div>
