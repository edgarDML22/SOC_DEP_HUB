...
<template>
  <div class="font-sans">
    ...
    <!-- ========================================= -->
    <nav class="hidden lg:flex w-full fixed top-0 z-100 px-4 pt-4 pb-4 backdrop-blur-sm pointer-events-none justify-center">
      <div class="pointer-events-auto w-full max-w-7xl rounded-2xl bg-white/80 backdrop-blur-md shadow-[0_8px_30px_rgb(0,0,0,0.08)] border border-surface-200/50 px-6 py-2.5 flex items-center justify-between transition-all">
        ...
        <router-link to="/admin/dashboard" class="flex items-center gap-3 shrink-0 group">
          ...
          <span class="font-bold text-lg tracking-tight text-surface-900 group-hover:text-primary-600 transition-colors">Admin</span>
        </router-link>

        <!-- Centro: Enlaces -->
        <div class="flex items-center gap-1 xl:gap-2 justify-center flex-1 mx-4 overflow-x-auto no-scrollbar">
            <router-link to="/admin/dashboard" class="group flex items-center gap-2 text-sm font-medium text-surface-500 px-3 py-2 rounded-xl transition-all active:scale-95 hover:bg-surface-100 hover:text-surface-900 [&.router-link-active]:bg-primary-600 [&.router-link-active]:text-white [&.router-link-active]:shadow-md [&.router-link-active]:font-bold whitespace-nowrap">
                <IconHome class="w-4 h-4 group-[.router-link-active]:text-white" /> Dashboard
            </router-link>
            <router-link to="/admin/reservations" class="group flex items-center gap-2 text-sm font-medium text-surface-500 px-3 py-2 rounded-xl transition-all active:scale-95 hover:bg-surface-100 hover:text-surface-900 [&.router-link-active]:bg-primary-600 [&.router-link-active]:text-white [&.router-link-active]:shadow-md [&.router-link-active]:font-bold whitespace-nowrap">
                <IconCalendar class="w-4 h-4 group-[.router-link-active]:text-white"/> Reservas
            </router-link>
            <router-link to="/admin/tournaments" class="group flex items-center gap-2 text-sm font-medium text-surface-500 px-3 py-2 rounded-xl transition-all active:scale-95 hover:bg-surface-100 hover:text-surface-900 [&.router-link-active]:bg-primary-600 [&.router-link-active]:text-white [&.router-link-active]:shadow-md [&.router-link-active]:font-bold whitespace-nowrap">
                <IconTrophy class="w-4 h-4 group-[.router-link-active]:text-white" /> Torneos
            </router-link>
            <router-link to="/admin/spaces" class="group flex items-center gap-2 text-sm font-medium text-surface-500 px-3 py-2 rounded-xl transition-all active:scale-95 hover:bg-surface-100 hover:text-surface-900 [&.router-link-active]:bg-primary-600 [&.router-link-active]:text-white [&.router-link-active]:shadow-md [&.router-link-active]:font-bold whitespace-nowrap">
                <IconHome class="w-4 h-4 group-[.router-link-active]:text-white" /> Espacios
            </router-link>
            <router-link to="/admin/instructors" class="group flex items-center gap-2 text-sm font-medium text-surface-500 px-3 py-2 rounded-xl transition-all active:scale-95 hover:bg-surface-100 hover:text-surface-900 [&.router-link-active]:bg-primary-600 [&.router-link-active]:text-white [&.router-link-active]:shadow-md [&.router-link-active]:font-bold whitespace-nowrap">
                <IconUser class="w-4 h-4 group-[.router-link-active]:text-white" /> Instructores
            </router-link>
            <router-link to="/admin/ludoteca/ludoteca-list" class="group flex items-center gap-2 text-sm font-medium text-surface-500 px-3 py-2 rounded-xl transition-all active:scale-95 hover:bg-surface-100 hover:text-surface-900 [&.router-link-active]:bg-primary-600 [&.router-link-active]:text-white [&.router-link-active]:shadow-md [&.router-link-active]:font-bold whitespace-nowrap">
                <IconBaby class="w-4 h-4 group-[.router-link-active]:text-white" /> Ludoteca
            </router-link>
            <router-link to="/admin/reports" class="group flex items-center gap-2 text-sm font-medium text-surface-500 px-3 py-2 rounded-xl transition-all active:scale-95 hover:bg-surface-100 hover:text-surface-900 [&.router-link-active]:bg-primary-600 [&.router-link-active]:text-white [&.router-link-active]:shadow-md [&.router-link-active]:font-bold whitespace-nowrap">
        ...
        <div class="flex items-center gap-3 shrink-0">
            ...
            <div class="relative" ref="profileDropdown">
                ...
                <div v-if="menuOpen" class="absolute top-14 right-0 w-64 bg-white rounded-2xl border border-surface-100 shadow-[0_15px_50px_rgba(0,0,0,0.1)] p-3 z-50 flex flex-col gap-1 transition-all">
                    ...
                    <button class="px-4 py-2.5 text-sm font-bold text-red-600 hover:bg-red-50 hover:text-red-700 rounded-lg transition-colors text-left flex items-center gap-3 w-full" @click="logout">
                        Cerrar Sesión
                    </button>
                </div>
            </div>
    ...
    <!-- Top Bar (Mobile) -->
    <div class="lg:hidden fixed top-0 left-0 w-full px-5 py-3 bg-white/90 backdrop-blur-xl border-b border-surface-200 z-110 flex items-center justify-between shadow-sm">
    ...
    <nav class="lg:hidden fixed bottom-0 left-0 w-full bg-white/90 backdrop-blur-xl border-t border-surface-200 z-100 px-2 pt-2 pb-[max(env(safe-area-inset-bottom),0.5rem)] shadow-[0_-10px_20px_rgba(0,0,0,0.03)] selection:bg-transparent">
        <div class="flex items-center justify-around h-[64px] pb-1 gap-1">
            
            <router-link to="/admin/dashboard" class="flex flex-col items-center justify-center gap-1 group w-[20%] h-full relative rounded-xl active:scale-95 transition-all [&.router-link-active]:bg-primary-600 [&.router-link-active]:shadow-md">
                <IconHome class="w-[22px] h-[22px] text-surface-400 group-[.router-link-active]:text-white transition-colors" />
                <span class="text-[10px] font-medium text-surface-500 group-[.router-link-active]:text-white group-[.router-link-active]:font-bold transition-colors">Inicio</span>
            </router-link>

            <router-link to="/admin/reservations" class="flex flex-col items-center justify-center gap-1 group w-[20%] h-full relative rounded-xl active:scale-95 transition-all [&.router-link-active]:bg-primary-600 [&.router-link-active]:shadow-md">
                <IconCalendar class="w-[22px] h-[22px] text-surface-400 group-[.router-link-active]:text-white transition-colors" />
                <span class="text-[10px] font-medium text-surface-500 group-[.router-link-active]:text-white group-[.router-link-active]:font-bold transition-colors">Reservas</span>
            </router-link>

            <!-- Botón Central Dinámico: Menú Más -->
            <div class="flex flex-col items-center justify-center group w-[20%] relative transition-all" 
                 :class="(moreMenuOpen || isMoreActive) ? '-mt-6 active:scale-90' : 'h-full rounded-xl active:scale-95'" ref="moreDropdown">
                
                <button @click="toggleMoreMenu" class="flex flex-col items-center justify-center w-full h-full" :class="(moreMenuOpen || isMoreActive) ? '' : 'gap-1'">
                ...
                <div v-if="moreMenuOpen" class="absolute bottom-20 left-1/2 -translate-x-1/2 w-48 bg-white rounded-2xl border border-surface-200 shadow-2xl py-2 z-60 animate-fade-in origin-bottom">
                    <router-link to="/admin/tournaments" class="px-4 py-3 flex items-center gap-3 hover:bg-surface-50 text-surface-700 font-medium text-sm transition-colors" @click="moreMenuOpen = false">
                        <IconTrophy class="w-4 h-4 text-surface-400" /> Torneos
                    </router-link>
                    <router-link to="/admin/spaces" class="px-4 py-3 flex items-center gap-3 hover:bg-surface-50 text-surface-700 font-medium text-sm transition-colors" @click="moreMenuOpen = false">
                        <IconHome class="w-4 h-4 text-surface-400" /> Espacios
                    </router-link>
                    <router-link to="/admin/reports" class="px-4 py-3 flex items-center gap-3 hover:bg-surface-50 text-surface-700 font-medium text-sm transition-colors" @click="moreMenuOpen = false">
                        <IconGuests class="w-4 h-4 text-surface-400" /> Reportes
                    </router-link>
                    <div class="h-px bg-surface-100 mx-3 my-1"></div>
                    <button class="px-4 py-3 w-full flex items-center gap-3 hover:bg-red-50 text-red-600 font-bold text-sm transition-colors text-left" @click="logout">
            ...
            <router-link to="/admin/ludoteca/ludoteca-list" class="flex flex-col items-center justify-center gap-1 group w-[20%] h-full relative rounded-xl active:scale-95 transition-all [&.router-link-active]:bg-primary-600 [&.router-link-active]:shadow-md">
                <IconBaby class="w-[22px] h-[22px] text-surface-400 group-[.router-link-active]:text-white transition-colors" />
                <span class="text-[10px] font-medium text-surface-500 group-[.router-link-active]:text-white group-[.router-link-active]:font-bold transition-colors">Ludoteca</span>
            </router-link>

            <router-link to="/admin/instructors" class="flex flex-col items-center justify-center gap-1 group w-[20%] h-full relative rounded-xl active:scale-95 transition-all [&.router-link-active]:bg-primary-600 [&.router-link-active]:shadow-md">
                <IconUser class="w-[22px] h-[22px] text-surface-400 group-[.router-link-active]:text-white transition-colors" />
                <span class="text-[10px] font-medium text-surface-500 group-[.router-link-active]:text-white group-[.router-link-active]:font-bold transition-colors">Personal</span>
            </router-link>
